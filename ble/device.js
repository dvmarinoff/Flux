...
class Controllable {
    ...
    onControlPoint (e) {
        ...
        console.log(`on procedure complate: ${response} ${operation} ${result}`);
    }
}
...
var fitnessMachineStatusCodes = {
    '0x00': {param: null,    msg: 'Reserved for Future Use'},
    '0x01': {param: null,    msg: 'Reset'},
    '0x02': {param: null,    msg: 'Fitness Machine Stopped or Paused by the User'},
    '0x07': {param: 'Uint8', msg: 'Target Resistance Level Changed'},
    '0x08': {param: 'Int16', msg: 'Target Power Changed'},
    '0x12': {param: '',      msg: 'Indoor Bike Simulation Parameters Changed'},
